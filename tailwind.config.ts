	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				"pulse-glow": {
					"0%, 100%": { 
						filter: "drop-shadow(0 0 0.75rem rgb(155, 135, 245, 0.7))" 
					},
					"50%": { 
						filter: "drop-shadow(0 0 1.5rem rgb(155, 135, 245, 1))" 
					}
				},
				"float": {
			...
			backgroundImage: {
				'carbon': "url('/public/lovable-uploads/68b6ce2a-f76a-4923-a91b-f0f6f581f887.png')",
				'gradient-cyber': "linear-gradient(to bottom right, #9b87f5, #4fd1c5)"
			}
		}
	},
